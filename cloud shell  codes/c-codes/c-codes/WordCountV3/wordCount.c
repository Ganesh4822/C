...
int main(int argc, char** argv)
{
    ...
    list_t* wordlist = creatList();
    printf("listcreated\n");
    
    char* line = NULL;
    size_t length;
    int read;
    ReadFileAndFillList(wordlist,inFile);
    //ShowVector(wordVec);
    printf("Size of vector is %ld\n",get_size(wordlist));
    printf("total size of words is %ld\n",get_total_words(wordlist));
    ...
    while(1)
    {
        ...
        int count = getWordCount(wordlist,searchString);
